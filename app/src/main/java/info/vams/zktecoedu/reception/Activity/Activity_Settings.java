...
public class Activity_Settings extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* LinearLayout root = (LinearLayout)findViewById(android.R.id.list).getParent().getParent().getParent();
        Toolbar bar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.app_barr_layout, root, false);
        root.addView(bar, 0);
        ImageView imageView = (ImageView)root.findViewById(R.id.ivLogo_appbar);
        Utilities.setUserLogo(this,imageView);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utilities.redirectToHome(Activity_Settings.this);
            }
        });*/
