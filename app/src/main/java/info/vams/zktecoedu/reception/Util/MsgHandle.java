...
public class MsgHandle extends Handler {
    ...
    public MsgHandle(Context context, MsgDialog Dialog,boolean isApprove) {
        funcID = FUNC_OTHER;
        mContext = context;
        mDialog = Dialog;
        isfromApprove = isApprove;
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case Common.MSG_GET_FIRM:
                if(isfromApprove){
                    mDialog.showPrintCompleteMsgDialogForApproveVisitor("Result = " + mResult);
                }else{
            ...
            case Common.MSG_DATA_SEND_END:
                if(isfromApprove){
                    if (mBattery != null && !mBattery.equals("")) {
                        mDialog.showPrintCompleteMsgDialogForApproveVisitor((mResult + "\nBattery: " + mBattery));
                    } else {
                        mDialog.showPrintCompleteMsgDialogForApproveVisitor(mResult);
                    }
                }else {
            ...
            case Common.MSG_WRONG_OS:
                if(isfromApprove){
                    mDialog.showPrintCompleteMsgDialogForApproveVisitor(mContext
