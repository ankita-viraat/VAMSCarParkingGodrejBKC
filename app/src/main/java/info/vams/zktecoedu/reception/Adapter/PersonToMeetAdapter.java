...
public class PersonToMeetAdapter extends RecyclerView.Adapter {
    Context context;
    ...
    public PersonToMeetAdapter(Context context, ArrayList<VisitorLogPersonToVisit> employeeListsCollection,
                               VisitorEntryActivityOne visitorEntryActivityOne,
                               CreateAppointmentActivityOne createAppointmentActivityOne) {
