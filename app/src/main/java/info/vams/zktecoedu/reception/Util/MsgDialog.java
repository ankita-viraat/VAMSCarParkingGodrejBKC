...
public class MsgDialog {
    ...
    public void showPrintCompleteMsgDialog(final String message) {
        ...
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setCancelable(false);
        if(message.equalsIgnoreCase("ERROR_NOT_MATCH_ADDRESS")){
            mProgressDialog.setMessage(message + "\n" + "Please Turn the Printer On " + "\n" +"Visitor Entry Successfull");
        }else if(message.equalsIgnoreCase(mContext.getString(R.string.error_message_none))){
            mProgressDialog.setMessage(message + "\n" + "Visitor Entry Successfull");
        }else if (message.equalsIgnoreCase("ERROR_WRONG_LABEL")){
            mProgressDialog.setMessage(message + "\n" + "Please Set The Label From The Settings " + "\n" +"Visitor Entry Successfull");
        }else if (message.equalsIgnoreCase("ERROR_OUT_OF_MEMORY")){
            mProgressDialog.setMessage(message + "\n" +"Visitor Entry Successfull");
        } else{
            mProgressDialog.setMessage(message);
        }
        ...
        mProgressDialog.setButton(mContext.getString(R.string.button_ok),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        dialog.cancel();
                        if(message.equalsIgnoreCase(mContext.getString(R.string.error_message_none))){
                            mContext.startActivity(new Intent(mContext,
                                    HomeScreenActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                        }else if(message.equalsIgnoreCase("ERROR_NOT_MATCH_ADDRESS")){
                            mContext.startActivity(new Intent(mContext,
                                    HomeScreenActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                        }else if(message.equalsIgnoreCase("ERROR_WRONG_LABEL")){
                            mContext.startActivity(new Intent(mContext,
    ...
    public void showPrintCompleteMsgDialogForApproveVisitor(final String message) {
