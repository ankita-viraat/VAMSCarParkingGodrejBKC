...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    private void createCameraSource(final boolean autoFocus, final boolean useFlash) {
        ...
        final BarcodeDetector barcodeDetector = new BarcodeDetector.Builder(context).setBarcodeFormats(2048).build();
...
//                    final Barcode barcode = items.get(key);
//                    System.out.println("Barcode Format: " + barcode.format);
//                    if (/*!isBarcodeDetected && */barcode.format == 12) {
//                        System.out.println("Barcode Raw: " + barcode.rawValue);
//                        System.out.println("Barcode valueFormat: " + barcode.valueFormat);
//                        break;
//                    }
//                }
//            }
//        });
        ...
        builder = builder.setFocusMode(
                autoFocus ? Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE : Camera.Parameters.FOCUS_MODE_AUTO);
    ...
    public void setAutoFocus(boolean continuous){
        ...
        mCameraSource.setFocusMode(autoFocus ?Camera.Parameters.FOCUS_MODE_AUTO : Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE );
    }
    /**
